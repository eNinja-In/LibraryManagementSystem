...
class library_man():
    def __init__(self,root):
        ...
        # self.root.wm_iconbitmap('icon.icon')
...
############################################################################################   
        ...
        def SelectBook(event):
            ...
            ConnectionDatabase=mysql.connector.connect(host=HostName,username=UserName,password=PassCode,database=DataBase)
    ...
    def LmsExit(self):
        iexit=msg.askyesno(DataBase,"Do you want to exit")
        if iexit == True:
            exit()
        else:
            pass
